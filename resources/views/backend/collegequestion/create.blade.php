...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                {!! Form::label('collegeyear_id', 'Year: <span class="required">*</span>',['class' => 'col-sm-2 col-form-label'],false); !!}
                <div class="col-sm-10">
                    {!! Form::select('collegeyear_id', $data['que'], null,['class' => 'form-control','placeholder' => 'Select Year',]) !!}
                    @error('collegeyear_id')
                    <span class="text text-danger">{{$message}}</span>
                    @enderror
                </div>
            </div>
