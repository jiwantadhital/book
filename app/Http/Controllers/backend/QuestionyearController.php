...
class QuestionyearController extends BackendBaseController
{
    protected $route ='admin.questionyear.';
    protected $panel ='Question Year';
    protected $view ='backend.questionyear.';
    protected $title;
    protected $model;
    function __construct(){
        $this->model = new questionyears();
    }
