...
use App\Models\collegequestions;
...
class CollegequestionController extends BackendBaseController
{
    protected $route ='admin.collegequestion.';
    protected $panel ='College Question';
    protected $view ='backend.collegequestion.';
    protected $title;
    protected $model;
    function __construct(){
        $this->model = new collegequestions();
    }
    ...
    public function create()
    {
        ...
        $data['que'] = collegeyears::pluck('name','id');
