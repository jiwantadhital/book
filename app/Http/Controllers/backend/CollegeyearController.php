...
use App\Models\collegeyears;
use App\Models\questionyears;
use Illuminate\Http\Request;

class CollegeyearController extends BackendBaseController
{
    protected $route ='admin.collegeyear.';
    protected $panel ='College Year';
    protected $view ='backend.collegeyear.';
    protected $title;
    protected $model;
    function __construct(){
        $this->model = new collegeyears();
    }
...
//        $request->request->add(['updated_by' => auth()->user()->id]);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route($this->__loadDataToView($this->route . 'index'))->with('success',$this->panel .' Update Successfully');
    }
}
