...
class SolutionController extends BackendBaseController
{
    protected $route ='admin.solution.';
    protected $panel ='Solution';
    protected $view ='backend.solution.';
    protected $title;
    protected $model;
    function __construct(){
        $this->model = new solutions();
    }
